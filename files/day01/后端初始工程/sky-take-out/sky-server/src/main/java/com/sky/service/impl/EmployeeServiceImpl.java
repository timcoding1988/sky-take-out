...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee add(EmployeeDTO employeeDTO) {
        ...
        String md5 = DigestUtils.md5DigestAsHex((PasswordConstant.DEFAULT_PASSWORD + salt).getBytes());
    ...
    public PageResult page(EmployeePageQueryDTO employeePageQueryDTO) {
        ...
        List<Employee> employeeList = employeeMapper.findByName(employeePageQueryDTO.getName());
